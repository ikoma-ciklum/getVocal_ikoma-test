...
const ListItem: FC = ({ text, status, index }: TProps): ReactElement => (
    <li
        tabindex={0}
        id={text}
        className={classNames("flex justify-between item border-[1px] rounded-[10px] border-gray-300 p-3 mb-2 focus:outline-transparent focus:outline-0 focus:ring-1", {
